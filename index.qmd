...
- NAVSA Conference 2023: "**Re**vision, **Re**turn, **Re**form"
...
- "Re-" :handshake: text mining 	
    - small details: hard to notice with one's eyes, but easy to notice with computer
...
## Data: Which Poets / Poetry? {.smaller}
...
## Results: Take Aways {visibility="hidden"}
...
- ID trends in "re-" use: 
    - Thematics: Which "re-" words are keywords? 
    - Stylistics: One word many times? Many words one time?
...
- Swinburne's "Re-Risen": 12x: 80% of "Re-" Words
    - form: alliterative 
    - content: ressurection

## Results: Take Aways

- DG Rossetti's "Re-Born"
    - *Hapax Legomenon*
    - Hyphenated prefixes and compound words are common in DGR's poetry
        - “a-heap,” “cukoo-throb,” etc.
    - "born": 48x and "birth": 46x | "ressurect-": 1x and "re-born": 1x 
 
    - Hypotheses:
        - uninterested in signifying repetition through "re-"
        - more interested in birth than rebirth?

## Results: Take Aways {.smaller}

- "Re-Illume" in Context (Hardy and Field)
    - Extremely rare
    - Chiefly poetic
    - 1758 &ndash; present
...
## Which Words Accompany "Re-" Words?

- J. R. Firth (Linguist): "You shall know a word by the company it keeps." (1957)
- IDing (frequently) co-occuring terms can clarify their meaning
...
- Swinburne
    - "re-": "life", "dead" (2x), "dust", "mortal"
        - re- associated with life + death, mortality, etc.
    - "re-risen" + "prison": rhyme
- Hardy
    - "re-": "time" (2x), "semipiternal" (everlasting), "killing", "death", "lives" "new", "olden"
...
- Are "re-" words in positive or negative contexts?
- Sentiment Analysis
